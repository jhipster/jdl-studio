...
Hello, this is [JDL-Studio](https://jhipster.github.io/jdl-studio/), an online tool for drawing UML diagrams for [JHipster](https://jhipster.github.io) based on the [JDL syntax](https://jhipster.github.io/jdl). It tries to keep its syntax visually as close as possible to the generated UML diagram without resorting to ASCII drawings.
